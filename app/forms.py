...
class CreateDataFactoryForm(FlaskForm):
    subscriptionID = StringField('SubscriptionId')
    rg_name = SelectField('Resource Group Name')
    datafactoryName = StringField('Data Factory Name')
    submit = SubmitField('Create Data Factory!')
    region = SelectField('Region', choices=[('eastasia','East Asia'),
        ('southeastasia','Southeast Asia'),
        ('centralus','Central US'),
        ('eastus','East US'),
...
class CreateStorageAccountForm(FlaskForm):
    rg_name = SelectField('Resource Group Name')
    subscriptionID = StringField('SubscriptionId')
    storageName = StringField('Storage Account Name')
    submit = SubmitField('Create Storage Account!')
    region = SelectField('Region', choices=[('eastasia','East Asia'),
        ('southeastasia','Southeast Asia'),
        ('centralus','Central US'),
        ('eastus','East US'),
